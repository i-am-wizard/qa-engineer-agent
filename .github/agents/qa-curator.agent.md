...
<!-- GENERATED by scripts/build-copilot.py from agents/qa-curator.md. Do not edit directly; run `make build-copilot` after editing the source. -->
...
2. A **Curation Summary** returned to the orchestrator (format in `.github/skills/quality-engineer/references/output-templates.md`)
