...
<!-- GENERATED by scripts/build-copilot.py from agents/qa-writer.md. Do not edit directly; run `make build-copilot` after editing the source. -->
...
1. Test files ready to be placed in the repository, each in the format:
   ...
   <full file content>
   ```
2. A **Coverage Summary** (format in `.github/skills/quality-engineer/references/output-templates.md`)
